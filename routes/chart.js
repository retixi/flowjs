...
router.all('/',function (req,res) {
    ...
    var pricesum_by_area="SELECT area,sum(price) as price FROM saleslist"+substr+" group by area"
    var pricesum_by_cate="SELECT cate,sum(price) as price FROM saleslist"+substr+" group by cate"
